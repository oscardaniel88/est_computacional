...
```{r, eval=TRUE, fig.height=4.5, fig.width=4.5}
...
[Simulación de retiro](https://shiny.rstudio.com/gallery/retirement-simulation.html)

http://analytics.teamnetwork.org/jahumada/powerPaper/
